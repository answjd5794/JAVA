...
/**
 * 
 * 가변형 인수 => 메서드 매개변수의 갯수가 실행될 때 마다 다를 때 사용한다. 메서드안에서는 배열로 처리된다. 한가지 자료형만 사용할 수
 * 있다.
 * 
 */
public class T01_ArgsTest {
	...
	// 가변형 인수와 일반적인 인수를 같이 사용할 경우에는 가변형 인수를 제일 뒷 쪽에 배치해야 한다.
	...
	public static void main(String[] args) {
		...
		System.out.println(at.sumArg(new int[] { 1, 2, 3 }));
