...
public class T01_stackQueTest {
	/**
	 * Stack => 후입선출(LIFO)의 자료구조
	 * Que => 선입선출(FIFO)의 자료구조
	 * 
	 * Stack과 Que는 LinkedList를 이용하여 사용할 수 있다.
	 * 
	 */
	 ...
	 public static void main(String[] args) {
		...
		stack.push("변학도");
		stack.push("강감찬");
		System.out.println("현재 stack값들은 : " + stack);
		
		String data = stack.pop();
		System.out.println("꺼내온 자료  : " + data);
		System.out.println("꺼내온 자료  : " + stack.pop());
		System.out.println("현재 스택의 값 : " + data);

		stack.push("성춘향");
		System.out.println("현재 스택의 값들 : " + stack);
		System.out.println("꺼내온 자료 : " + stack.pop());
